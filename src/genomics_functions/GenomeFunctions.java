...
public class GenomeFunctions {
	...
	private static final HashMap<Character, Character> nuc_comp = new HashMap<Character, Character>() {
		{
			put('A', 'T');
			put('C', 'G');
			put('G', 'C');
	...
	public static String read_in_chr_fasta_file(String c, String chr_header)
			throws IOException {

		// Read in the chromosome fasta file
		BufferedReader fasta_file = new BufferedReader(new FileReader(
				chr_header + c + ".fasta"));
	...
	public static String read_in_chr_split_fasta_file(String c,
			String chr_header, int file_idx) throws IOException {
